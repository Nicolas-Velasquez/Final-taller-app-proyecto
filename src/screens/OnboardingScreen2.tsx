...
interface OnboardingScreen2Props { onNext: () => void; onSkip: () => void; }
...
const styles = StyleSheet.create({
  ...
  nextButton: { backgroundColor: '#43a047', borderRadius: 14, width: width - 48, paddingVertical: 16, alignItems: 'center' },
